...
import synthlax.lostcitiesfork.api.ILostCityCityStyle;
import synthlax.lostcitiesfork.varia.ChunkCoord;
import synthlax.lostcitiesfork.varia.Tools;
import synthlax.lostcitiesfork.worldgen.lost.regassets.CityStyleRE;
import synthlax.lostcitiesfork.worldgen.lost.regassets.data.DataTools;
import synthlax.lostcitiesfork.worldgen.lost.regassets.data.ObjectSelector;
...
public class CityStyle implements ILostCityCityStyle {
    ...
    @Override
    public synchronized void init(CommonLevelAccessor level) {
        if (!resolveInherit) {
            resolveInherit = true;
            if (inherit != null) {
