...
import synthlax.lostcitiesfork.api.ILostSphere;
...
import synthlax.lostcitiesfork.worldgen.lost.cityassets.PredefinedCity;
import synthlax.lostcitiesfork.worldgen.lost.cityassets.PredefinedSphere;
...
public class CitySphere implements ILostSphere {
    ...
    private static final Map<ChunkCoord, CitySphere> CITY_SPHERE_CACHE = new java.util.concurrent.ConcurrentHashMap<>();
    ...
    public static synchronized CitySphere getCitySphere(ChunkCoord coord, IDimensionInfo provider) {
        ...
        CitySphere cached = CITY_SPHERE_CACHE.get(coord);
        if (cached == null) {
