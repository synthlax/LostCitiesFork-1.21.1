...
import synthlax.lostcitiesfork.varia.Counter;
...
import synthlax.lostcitiesfork.worldgen.lost.cityassets.Building;
import synthlax.lostcitiesfork.worldgen.lost.cityassets.CityStyle;
import synthlax.lostcitiesfork.worldgen.lost.cityassets.MultiBuilding;
import synthlax.lostcitiesfork.worldgen.lost.regassets.data.MultiSettings;
...
public class MultiChunk {
    ...
    private static final TimedCache<ChunkCoord, MultiChunk> MULTICHUNKS = new TimedCache<>("MULTICHUNKS", Config.CACHE_CLEANUP_SECONDS::get);
