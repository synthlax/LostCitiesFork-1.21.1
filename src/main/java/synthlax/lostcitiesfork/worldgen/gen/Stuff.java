package synthlax.lostcitiesfork.worldgen.gen;

import synthlax.lostcitiesfork.worldgen.ChunkDriver;
...
import synthlax.lostcitiesfork.worldgen.lost.cityassets.StuffObject;
import synthlax.lostcitiesfork.worldgen.lost.regassets.StuffSettingsRE;
import synthlax.lostcitiesfork.worldgen.lost.regassets.data.BlockMatcher;
import synthlax.lostcitiesfork.worldgen.lost.regassets.data.ResourceLocationMatcher;
...
public class Stuff {
    ...
    public static void generateStuff(LostCityTerrainFeature feature, BuildingInfo info) {
        feature.getRand().setSeed(info.coord.chunkX() * 2570174657L + info.coord.chunkZ() * 101754695981L);
    ...
    private static void actuallyGenerateStuff(LostCityTerrainFeature feature, BuildingInfo info, StuffSettingsRE settings, CompiledPalette palette, boolean inBuilding) {
        ...
        RandomSource rand = feature.getRand();
