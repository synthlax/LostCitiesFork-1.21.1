...
import synthlax.lostcitiesfork.setup.ForgeEventHandlers;
...
public class LostCityFeature extends Feature<NoneFeatureConfiguration> {
     ...
     */
    private final Map<ResourceKey<Level>, IDimensionInfo> dimensionInfo = new java.util.concurrent.ConcurrentHashMap<>();
    ...
    public IDimensionInfo getDimensionInfo(WorldGenLevel world) {
        ...
        if (profileName != null) {
            ...
            return dimensionInfo.computeIfAbsent(type, t -> {
